...
AAH_SAFE_ADDR = env('AAH_SAFE_ADDR')
...
AAH_CHAIN_ID = 21133
AAH_TX_GAS = 21000
AAH_ACCUMULATION_PERIOD = 60
AAH_BLOCK_GENERATION_TIME = 5
AAH_GAS_PRICE_UPDATE_PERIOD = 60
AAH_GAS_PRICE_COEFFICIENT = 0.1
AAH_MAX_GAS_PRICE = 300000000000
AAH_MIN_GAS_PRICE = 5000000000

TRONGRID_API_KEY = [env('TRONGRID_API_KEY', default='')]
ETHERSCAN_KEY = env('ETHERSCAN_KEY', default='')
BSCSCAN_KEY = env('BSCSCAN_KEY', default='')
C4EXSCAN_KEY = env('C4EXSCAN_KEY', default='')
